    ...
    let spawnBosses = (() => {
        ...
        return census => {
            if (timer > 60 && ran.dice(160 - timer)) {
                ...
                timer = 0;
                let choice = [];
                switch (ran.chooseChance(2, 2, 2, 2, 1)) {
                    case 0: 
                        choice = [[Class.elite_destroyer], 2, 'a', 'nest'];
                        break;
                    case 1: 
                        choice = [[Class.palisade], 2, 'castle', 'norm'];         
                        sockets.broadcast('Someone black is comming (dont be racist)...');
                        break;
                    case 2: 
                    ...
                    case 3: 
                        ...
                        break;
                    case 4: 
                        choice = [[Class.elite_hiveshooter], 1, 'a', 'nest', 'castle', 'norm'];
                        sockets.broadcast('This is going to sting...')
                        break;
                }
        ...
        return () => {
            ...
            // Bots
                if (bots.length < c.BOTS) {
                    ...
                    o.color = 17;
                    o.define(Class.bot);
                    o.define((ran.dice(50)) ? ran.choose([Class.basic]) : ran.choose([Class.octo, Class.triple, Class.overlord, Class.anni, Class.nailgun, Class.penta, Class.stream, Class.master, Class.single, Class.hybrid, Class.hiveshooter, Class.carrier, Class.spray, Class.auto4, Class.bentboomer, Class.sidewind])),
                ...
                bots.forEach(o => {
                    if (o.skill.level < 45) {
                        o.skill.score += 500;
                        o.skill.set([7, 9, 9, 9, 6, 0, 0, 0, 2, 0]); // 1-RELOAD, 2-BULLET DAMAGE, 3-BULLET PENATRATION, 4-BULLET HEALTH, 5-BULLET SPEED, 6-MOVEMENT SPEED, 7-SHIELD CAPACITY, 8-SHIELD REGENERATION, 9-MAX HEALTH, 10-BODY DAMAGE
                        o.skill.maintain();
                    }
                });
